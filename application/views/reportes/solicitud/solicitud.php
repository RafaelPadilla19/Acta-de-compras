        ...
        <table class="m-2 table table-sm table-bordered border-dark text-center txt-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="3" style="margin: 0;"><?php echo convertirFecha($solicitud->fecha); ?></td>
                    <td colspan="4"><?php echo $solicitud->amsj; ?></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">NOMBRE DEL SOLICITANTE:</td>
                    <td colspan="3"> <?php echo $solicitud->nombre_solicitante; ?></td>
                    <td class=" fw-bold align-middle col-2" rowspan="3">FIRMA DEL SOLICITANTE:</td>
                    <td class="col-2" rowspan="3" colspan="3"></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">CARGO:</td>
                    <td colspan="3"><?php echo $solicitud->cargo_solicitante; ?></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">DEPENDENCIA:</td>
                    <td colspan="3"><?php echo $solicitud->dependencia_solicitante; ?></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">NOMBRE DEL AUTORIZANTE:</td>
                    <td colspan="3"><?php echo $solicitud->nombre_autorizante; ?></td>
                    <td class="col-1 fw-bold align-middle col-2" rowspan="3">FIRMA DEL AUTORIZANTE:</td>
                    <td class="col-2" rowspan="3" colspan="3"></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">CARGO:</td>
                    <td colspan="3"><?php echo $solicitud->cargo_autorizante; ?></td>
                </tr>
                <tr>
                    <td class="text-start fw-bold" colspan="3">DEPENDENCIA:</td>
                    <td colspan="3"><?php echo $solicitud->dependencia_autorizante; ?></td>
                </tr>
                ...
                <?php for ($i = 0; $i < 4; $i++) :   ?>
                    <tr>
                        ...
                        <td class="align-middle" colspan="2"><?php echo (isset($productosPagina[$i]->cifra_presupuestada)) ? "" : ""; ?></td>
                    </tr>
                <?php endfor; ?>
<!-- 
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><?php //echo $solicitud->valor_compra;
                                    ?></td>
                ...
                <tr style="height: 23px;">
                    ...
                    <td colspan="3"><?php echo $propuesta->nombre_recibido_por;
                                    ?>
                    </td>
                ...
                <tr style="height: 23px;">
                    ...
                    <td colspan="3"><?php echo $propuesta->cargo_de_recibido;
                                    ?>
                    </td>
                </tr>
                <tr style="height: 23px;">
        ...
        <div class="ocultar d-flex justify-content-center my-3">
            ...
            <a class="btn btn-primary me-3" href="<?php echo base_url() . "Reporte/documentacionCompra/" . $id; ?>">Volver</a>
            <?php if (!empty($asignacion)) { ?>
            <a class="btn btn-primary" target="_blank" href="<?php echo base_url() . "Reporte/actualizarSolicitud/" . $id; ?>">Actualizar</a>
            <?php } ?>
        ...
        <nav aria-label="Page navigation example" class="ocultar mb-4">
            <ul class="pagination justify-content-center">
                <li class="page-item 
                    ...
                    <a class="page-link" href="<?php echo base_url() . "Reporte/solicitudRequerimiento/" . $id . "?pag=" . ((int)$_GET["pag"] - 1); ?>" tabindex="-1" aria-disabled="true">Anterior</a>
                </li>

                <?php for ($i = 1; $i <= $paginas; $i++) { ?>
                    <li class="page-item <?php echo $_GET['pag'] == $i ? 'active' : '' ?>"><a class="page-link" href="<?php echo base_url() . "Reporte/solicitudRequerimiento/" . $id . "?pag=" . $i ?>"><?php echo $i ?></a>
                    </li>
                <?php } ?>
                ...
                <li class="page-item 
                    ...
                    <a class="page-link" href="<?php echo base_url() . "Reporte/solicitudRequerimiento/" . $id . "?pag=" . ((int)$_GET["pag"] + 1) ?>" tabindex="-1" aria-disabled="true">Siguiente</a>
                </li>
            </ul>
        </nav>
