...
<main style="margin: 20px 60px;">
    ...
    <table class="m-2 table table-sm table-bordered border-dark text-center txt-table">
        <thead> 
            <tr>
                <th class="col-1 border border-white border-bottom-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th class="col-1 border border-white border-bottom-0 border-end-0"></th>
                <th colspan="4">AMSJ-ADJ2021</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="text-start fw-bold" colspan="3">FECHA: (D-M-A)</td>
                <td colspan="5">miercoles, 8 de octubre de 2021</td>
                <td colspan="4">205</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="col-1 col-md-1 align-middle fw-bold">1</td>
            ...
            <tr>
                <td class="col-1 col-md-1 align-middle fw-bold">2</td>
                <td class="col-1 col-md-1 align-middle">20</td>
                <td class="col-1 col-md-1 align-middle">Unidad</td>
                <td class="align-middle" colspan="5">Conos anaranjados de 70 cm con cinta reflectiva</td>
                <td class="align-middle" colspan="2"></td>
            ...
            <tr>
                <td class="col-1 col-md-1 align-middle fw-bold">3</td>
                <td class="col-1 col-md-1 align-middle">20</td>
                <td class="col-1 col-md-1 align-middle">Unidad</td>
                <td class="align-middle" colspan="5">Conos anaranjados de 70 cm con cinta reflectiva</td>
                <td class="align-middle" colspan="2"></td>
            ...
            <tr>
                <td class="col-1 col-md-1 align-middle fw-bold">4</td>
                <td class="col-1 col-md-1 align-middle">20</td>
                <td class="col-1 col-md-1 align-middle">Unidad</td>
                <td class="align-middle" colspan="5">Conos anaranjados de 70 cm con cinta reflectiva</td>
                <td class="align-middle" colspan="2"></td>
            ...
            <tr>
                <td class="col-1 col-md-1 align-middle fw-bold">5</td>
                <td class="col-1 col-md-1 align-middle">20</td>
                <td class="col-1 col-md-1 align-middle">Unidad</td>
                <td class="align-middle" colspan="5">Conos anaranjados de 70 cm con cinta reflectiva</td>
                <td class="align-middle" colspan="2"></td>
            ...
            <tr>
                <td colspan="12" class="text-start">
                    En atención al articulo 10 inciso e) y 11 de la Ley de adquisiciones y contratación de la administración pública de la (LACAP), 
