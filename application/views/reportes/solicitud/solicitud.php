<?php
    ...
    if(!isset($_GET['pag'])){
        header("Location:" . base_url()."Reporte/solicitudRequerimiento/".$acta->id."?pag=1");
    }
        ...
        <nav aria-label="Page navigation example" class="ocultar mb-4">
            <ul class="pagination justify-content-center">
                <li class="page-item 
                    ...
                    <a class="page-link"
                        href="<?php echo base_url()."Reporte/solicitudRequerimiento/".$acta->id."?pag=".$_GET["pag"]-1 ?>"
                        tabindex="-1" aria-disabled="true">Anterior</a>
                </li>

                <?php for ($i = 1; $i <= $paginas; $i++) { ?>
                <li class="page-item <?php echo $_GET['pag']==$i ? 'active':'' ?>"><a class="page-link"
                        href="<?php echo base_url()."Reporte/solicitudRequerimiento/".$acta->id."?pag=".$i ?>"><?php echo $i ?></a>
                </li>
                <?php } ?>
