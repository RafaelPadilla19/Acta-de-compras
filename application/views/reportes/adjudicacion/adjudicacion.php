...
<main style="margin: 0 60px;">
    ...
    <p class="mb-2 txt">
        La unida de Adquisiciones y Contrataciones Institucionales UACI, de la Alcaldía Municipal de San Julián Departamento de Sonsonate, con base en el
        requerimiento n° 205 presentada por la unidad solicitante: Cuerpo de Agentes Municipales cumpliendo con lo establecido
    ...
    <p class="text-word txt">
        Habiendo analizada(as) y evaluda(as) las oferta(as) recibida(as) por la UACI las cuales cumplen las condiciones legales, técnico
    ...
    <p class="text-word txt">
        Por tanto en base a las facultades que me ha otorgado el Consejo Municipal en uso de las facultades legales que les confiere el Código Municipal
        y en conformidad con el Articulo 18 de la ley de Adquisiciones y Contrataciones de la Administración pública. ADJUDIQUESE.
    </p>
    ...
    <p class="text-start txt">
        NIT: <span class="fw-bold"><ins>1908120983</ins></span> NCR O DUI: <span class="fw-bold"><ins>98712873-2</ins></span>
    </p>
