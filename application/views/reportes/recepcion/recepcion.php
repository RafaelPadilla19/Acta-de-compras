...
<body ng-app="app" ng-controller="app-controller">
    ...
    <main style="margin: 5px 60px;">
                    ...
                    <tr>
                        <td colspan="12" class="text-start txt">
                            <p class="txt">
                                ...
                                Departamento de Sonsonate A las: <span class="fw-bold text-decoration-underline"><?php echo $recepcion->hora; ?></span>
                                del día: <span class="fw-bold text-decoration-underline"><?php echo (convertirFecha($recepcion->fecha) !== null) ? convertirFecha($recepcion->fecha) : ""; ?></span>
                            </p>
                            <p>
                                Reunidos con el proposito de hacer entrega formal por parte del proveedor: <span class="fw-bold text-decoration-underline"><?php echo $acta->nombre ?></span>
                            </p>
                            <p>
                            ...
                            <div class="d-flex justify-content-startrow g-0 ">
                                <div class="col-6 col-md-6">
                                    <p>
                                        Factura o Recibo presentado N°: <span class="fw-bold text-decoration-underline"><?php //echo $recepcion->numero_factura;
                                                                                                                        ?></span>
                                    </p>
                                </div>
                                <div class="col-6 col-md-6">
        ...
        <div class="ocultar d-flex justify-content-center my-3">
            ...
            <button data-bs-toggle="modal" data-bs-target="#modal-recepcion" class="btn btn-primary ">Actualizar</button>
        </div>
        <nav aria-label="Page navigation example" class="ocultar mb-4">
            <ul class="pagination justify-content-center">
                ...
                <?php for ($i = 1; $i <= $paginas; $i++) { ?>
                    <li class="page-item <?php echo $_GET['pag'] == $i ? 'active' : '' ?>"><a class="page-link" href="<?php echo base_url() . "Reporte/recepcion/" . $acta->solicitud_id . "?pag=" . $i ?>"><?php echo $i ?></a>
                    </li>
                <?php } ?>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="time" class="form-control" id="hora" ng-model="acta_de_recepcion.hora">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3 col-12">
                                    <label for="fecha" class="form-label">Fecha</label>
                                    <input type="date" class="form-control" id="fecha" ng-model="acta_de_recepcion.fecha" required>
                                </div>
                            </div>
        ...
        angular.module("app", []).controller("app-controller", function($scope, $http, $compile) {
            ...
            (function() {
                $http({
                    ...
                    $scope.acta_de_recepcion.fecha = new Date($scope.acta_de_recepcion.fecha[0], $scope.acta_de_recepcion.fecha[1] - 1, $scope.acta_de_recepcion.fecha[2]);
