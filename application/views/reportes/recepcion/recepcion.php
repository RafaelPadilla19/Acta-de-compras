<?php
    ...
    if(!isset($_GET['pag'])){
        header("Location:" . base_url()."Reporte/recepcion/".$acta->id."?pag=1");
    }
        ...
        <nav aria-label="Page navigation example" class="ocultar mb-4">
                <ul class="pagination justify-content-center">
                    ...
                    <?php echo $_GET['pag']<=1 ? 'disabled':'' ?>">
                        ...
                        <a class="page-link" href="<?php echo base_url()."Reporte/recepcion/".$acta->id."?pag=".$_GET["pag"]-1 ?>" tabindex="-1" aria-disabled="true">Anterior</a>
                    </li>
                    ...
                    <?php echo $_GET['pag']>=$paginas ? 'disabled':'' ?>">
                        ...
                        <a class="page-link" href="<?php echo base_url()."Reporte/recepcion/".$acta->id."?pag=".$_GET["pag"]+1 ?>" tabindex="-1" aria-disabled="true">Siguiente</a>
                    </li>
                </ul>
            </nav>
