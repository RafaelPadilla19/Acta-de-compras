...
<main class="bg-light mb-5" ng-app="app" ng-controller="app-controller">
    <div class="container  pt-4">
        ...
        <form>
            <div class="row">
                <div class="mb-3 col-4">
                    ...
                    <input type="date" class="form-control" value="09-09-2019" id="fecha"
                        ng-model="solicitud_requerimientos.fecha" required>
                </div>
                <div class="mb-3 col-4">
            ...
            <div class="row mb-3">
                <div class="mb-3 col-2">
                    ...
                    <input type="text" required class="form-control" id="valor_compra"
                        ng-model="solicitud_requerimientos.valor_compra" placeholder="" disabled>
                </div>
                <div class="mb-3 col-3">
                    <label for="forma_entrega" class="form-label">Forma de entrega</label>
                    <input type="text" class="form-control" id="forma_entrega"
                        ng-model="solicitud_requerimientos.forma_entrega" placeholder="Ingrese la forma de entrega"
                        required>
                </div>
                <div class="mb-3 col-3">
            ...
            <hr>
            <button type="button" data-bs-toggle="modal" data-bs-target="#modal-prod" class="btn btn-success mb-3"
                ng-click="reset()">Agregar Producto</button>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="number" class="form-control" id="cifra-presupuestada"
                                    ng-model="producto.cifra_presupuestada">
                            </div>
                        </div>
                        <div class="mb-3">
