            ...
            <div class="col-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url()."Reporte/declaracion/".$id; ?>" ng-if="orden==true && adjudicacionExist==true && recepcion==true" target="_blank" rel="noopener noreferrer"
                            class="btn btn-secondary ms-4">Ver declaracion</a>
