            ...
            <div class="col-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <button
                            class="btn btn-success <?php echo $solicitud->estado != "pendiente" ? "disabled" : ""; ?>"
                            data-bs-toggle="modal" data-bs-target="#modal-aceptacion">Aprobar</button>
                        ...
                        <a href="<?php echo (isset($orden_de_compra) &&  $orden_de_compra->tipo_documento == "recibo") ? base_url() . "Reporte/recibo/" . $id : base_url() . "Reporte/ordenCompra/" . $id; ?>"
                            class="btn btn-success ms-4" ng-if="orden==true" target="_blank">Ver Orden</a>
<!-- 
                        <button data-bs-toggle="modal" data-bs-target="#modal-orden" class="btn btn-success ms-4"
                            ng-if="orden==false">Crear Orden De Compra</button> -->

                        <a href="<?php echo base_url(); ?>Reporte/agregarOrden/<?php echo $id;?>" class="btn btn-success ms-4"
                            ng-if="orden==false" target="_blank">Crear Orden de Compra</a>

                        <a href="<?php echo base_url() . "Reporte/adjudicacion/" . $id; ?>" target="_blank"
                            rel="noopener noreferrer" ng-if="adjudicacionExist==true" class="btn btn-dark ms-4">Ver
                            Adjudicacion</a>
                        <button ng-if="adjudicacionExist==false" data-bs-toggle="modal"
                            data-bs-target="#modal-adjudicacion" class="btn btn-dark ms-4">Crear Adjudicacion</button>


                        <a href="<?php echo base_url() . "Reporte/recepcion/" . $id; ?>" ng-if="recepcion==true"
                            target="_blank" rel="noopener noreferrer" class="btn btn-primary ms-4">Ver Acta de
                            recepcion</a>
                        <button ng-if="recepcion==false" data-bs-toggle="modal" data-bs-target="#modal-recepcion"
                            class="btn btn-warning ms-4">Crear Acta de recepcion</button>

                        <a href="<?php echo base_url() . "Reporte/declaracion/" . $id; ?>"
                            ng-if="orden==true && adjudicacionExist==true && recepcion==true" target="_blank"
                            rel="noopener noreferrer" class="btn btn-secondary ms-4">Ver declaracion</a>
        ...
        <div class="modal fade" id="modal-aceptacion" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" class="form-control" id="costo-unitario"
                                        ng-model="orden_de_compra.lugar">
                            ...
                            <div class="row">
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="observaciones"
                                        ng-model="orden_de_compra.observaciones">
                                </div>
                                <div class="mb-3 col-6">
